...
function transonic_mio_model()
    ...
    pwlDict = GoML.pwl_constraint_data(lnr, vks);
    upperDict, lowerDict = GoML.trust_region_data(lnr, vks);
    ...
    GoML.add_regr_constraints!(m, x, y, lnr, nothing, vks, M=100., eq=true);
